...
const users: SeedUser[] = [
  { id: 'user-1', name: 'Alexandra Reed', email: 'customer@store.com', avatar: 'https://picsum.photos/seed/alex-avatar/200/200', role: 'customer', createdAt: '2025-01-15T10:00:00Z' },
  { id: 'user-2', name: 'Admin User', email: 'admin@store.com', avatar: 'https://picsum.photos/seed/admin-avatar/200/200', role: 'admin', createdAt: '2025-01-01T00:00:00Z' },
  { id: 'user-3', name: 'Marcus Chen', email: 'marcus@example.com', avatar: 'https://picsum.photos/seed/marcus/200/200', role: 'customer', createdAt: '2025-02-01T10:00:00Z' },
  { id: 'user-4', name: 'Sophia Williams', email: 'sophia@example.com', avatar: 'https://picsum.photos/seed/sophia/200/200', role: 'customer', createdAt: '2025-02-10T10:00:00Z' },
  { id: 'user-5', name: 'James Park', email: 'james@example.com', avatar: 'https://picsum.photos/seed/james/200/200', role: 'customer', createdAt: '2025-02-15T10:00:00Z' },
];

const categories: SeedCategory[] = [
  { id: 'cat-1', name: 'Electronics', slug: 'electronics', image: 'https://picsum.photos/seed/electronics-cat/600/400', productCount: 4 },
  { id: 'cat-2', name: 'Fashion', slug: 'fashion', image: 'https://picsum.photos/seed/fashion-cat/600/400', productCount: 3 },
  { id: 'cat-3', name: 'Home & Living', slug: 'home-living', image: 'https://picsum.photos/seed/home-cat/600/400', productCount: 3 },
  { id: 'cat-4', name: 'Beauty', slug: 'beauty', image: 'https://picsum.photos/seed/beauty-cat/600/400', productCount: 2 },
  { id: 'cat-5', name: 'Sports', slug: 'sports', image: 'https://picsum.photos/seed/sports-cat/600/400', productCount: 2 },
  { id: 'cat-6', name: 'Books', slug: 'books', image: 'https://picsum.photos/seed/books-cat/600/400', productCount: 1 },
];

const products: SeedProduct[] = [
  { id: 'prod-1', name: 'Wireless Noise-Cancelling Headphones', slug: 'wireless-noise-cancelling-headphones', description: 'Premium over-ear headphones with active noise cancellation, 30-hour battery life, and studio-quality sound.', price: 299.99, salePrice: 249.99, images: ['https://picsum.photos/seed/headphones/800/800', 'https://picsum.photos/seed/headphones2/800/800'], category: 'Electronics', tags: ['audio', 'wireless', 'noise-cancelling'], stock: 45, rating: 4.8, reviewCount: 128, variants: [{ type: 'color', value: 'Black', available: true }, { type: 'color', value: 'Silver', available: true }] },
  { id: 'prod-2', name: 'Smart Fitness Watch', slug: 'smart-fitness-watch', description: 'Track your health 24/7 with heart rate monitoring, GPS, and 7-day battery life.', price: 199.99, images: ['https://picsum.photos/seed/watch/800/800', 'https://picsum.photos/seed/watch2/800/800'], category: 'Electronics', tags: ['fitness', 'wearable', 'health'], stock: 62, rating: 4.5, reviewCount: 89, variants: [{ type: 'size', value: '40mm', available: true }, { type: 'size', value: '44mm', available: true }] },
  { id: 'prod-3', name: 'Premium Leather Messenger Bag', slug: 'premium-leather-messenger-bag', description: 'Handcrafted full-grain leather messenger bag with brass hardware and cotton lining.', price: 189.99, salePrice: 149.99, images: ['https://picsum.photos/seed/bag/800/800'], category: 'Fashion', tags: ['leather', 'bag', 'handcrafted'], stock: 23, rating: 4.7, reviewCount: 56, variants: [] },
  { id: 'prod-4', name: 'Minimalist Ceramic Desk Lamp', slug: 'minimalist-ceramic-desk-lamp', description: 'Artisan-made ceramic lamp with warm LED bulb. Perfect for focused work or ambient lighting.', price: 89.99, images: ['https://picsum.photos/seed/lamp/800/800'], category: 'Home & Living', tags: ['lighting', 'ceramic', 'minimalist'], stock: 34, rating: 4.6, reviewCount: 42, variants: [{ type: 'color', value: 'White', available: true }, { type: 'color', value: 'Terracotta', available: true }] },
  { id: 'prod-5', name: 'Organic Cotton T-Shirt Pack', slug: 'organic-cotton-tshirt-pack', description: 'Set of 3 premium organic cotton t-shirts in timeless colors. Sustainably sourced and manufactured.', price: 59.99, images: ['https://picsum.photos/seed/tshirt/800/800'], category: 'Fashion', tags: ['sustainable', 'cotton', 'essential'], stock: 78, rating: 4.4, reviewCount: 67, variants: [{ type: 'size', value: 'S', available: true }, { type: 'size', value: 'M', available: true }, { type: 'size', value: 'L', available: true }] },
  { id: 'prod-6', name: 'Smart Indoor Plant System', slug: 'smart-indoor-plant-system', description: 'Self-watering planters with app-controlled grow lights. Grow herbs and small plants year-round.', price: 129.99, images: ['https://picsum.photos/seed/plants/800/800'], category: 'Home & Living', tags: ['plants', 'smart', 'indoor'], stock: 19, rating: 4.3, reviewCount: 31, variants: [] },
  { id: 'prod-7', name: 'Natural Skincare Set', slug: 'natural-skincare-set', description: 'Complete skincare routine with cleanser, toner, and moisturizer. All-natural ingredients.', price: 79.99, salePrice: 64.99, images: ['https://picsum.photos/seed/skincare/800/800'], category: 'Beauty', tags: ['natural', 'skincare', 'routine'], stock: 51, rating: 4.6, reviewCount: 94, variants: [] },
  { id: 'prod-8', name: 'Yoga Mat & Block Set', slug: 'yoga-mat-block-set', description: 'Premium 6mm yoga mat with cork block and adjustable strap. Non-slip surface.', price: 69.99, images: ['https://picsum.photos/seed/yoga/800/800'], category: 'Sports', tags: ['yoga', 'fitness', 'cork'], stock: 27, rating: 4.7, reviewCount: 73, variants: [{ type: 'color', value: 'Sage', available: true }, { type: 'color', value: 'Navy', available: true }] },
  { id: 'prod-9', name: 'Japanese Chef Knife Set', slug: 'japanese-chef-knife-set', description: '3-piece Damascus steel knife set. Hand-forged in Seki City with rosewood handles.', price: 249.99, images: ['https://picsum.photos/seed/knives/800/800'], category: 'Home & Living', tags: ['kitchen', 'japanese', 'professional'], stock: 15, rating: 4.9, reviewCount: 38, variants: [] },
  { id: 'prod-10', name: 'Resistance Band Kit', slug: 'resistance-band-kit', description: '5-level resistance band kit for full-body workouts. Includes door anchor and carrying case.', price: 34.99, images: ['https://picsum.photos/seed/bands/800/800'], category: 'Sports', tags: ['fitness', 'portable', 'home-workout'], stock: 94, rating: 4.2, reviewCount: 115, variants: [] },
  { id: 'prod-11', name: 'Botanical Perfume Collection', slug: 'botanical-perfume-collection', description: 'Set of 3 rollerball perfumes inspired by gardens. Notes of bergamot, jasmine, and vetiver.', price: 89.99, images: ['https://picsum.photos/seed/perfume/800/800'], category: 'Beauty', tags: ['perfume', 'botanical', 'natural'], stock: 38, rating: 4.5, reviewCount: 52, variants: [] },
  { id: 'prod-12', name: 'Cashmere Blend Scarf', slug: 'cashmere-blend-scarf', description: 'Luxuriously soft cashmere-wool blend scarf. Oversized drape, finished with hand-rolled edges.', price: 119.99, salePrice: 89.99, images: ['https://picsum.photos/seed/scarf/800/800'], category: 'Fashion', tags: ['cashmere', 'scarf', 'winter'], stock: 29, rating: 4.8, reviewCount: 44, variants: [{ type: 'color', value: 'Oatmeal', available: true }, { type: 'color', value: 'Charcoal', available: true }] },
  { id: 'prod-13', name: 'Portable Bluetooth Speaker', slug: 'portable-bluetooth-speaker', description: 'Compact waterproof speaker with 360-degree sound and 24-hour playtime.', price: 79.99, images: ['https://picsum.photos/seed/speaker/800/800'], category: 'Electronics', tags: ['audio', 'bluetooth', 'portable'], stock: 71, rating: 4.4, reviewCount: 203, variants: [{ type: 'color', value: 'Teal', available: true }, { type: 'color', value: 'Black', available: true }] },
  { id: 'prod-14', name: 'Classic Hardcover Journal Set', slug: 'classic-hardcover-journal-set', description: 'Set of 2 lay-flat hardcover journals with archival paper. 200 pages each.', price: 24.99, images: ['https://picsum.photos/seed/journal/800/800'], category: 'Books', tags: ['journal', 'stationery', 'gift'], stock: 112, rating: 4.6, reviewCount: 78, variants: [] },
  { id: 'prod-15', name: 'Wireless Charging Pad', slug: 'wireless-charging-pad', description: 'Fast 15W wireless charging for all Qi-compatible devices. Sleek aluminum finish.', price: 39.99, images: ['https://picsum.photos/seed/charger/800/800'], category: 'Electronics', tags: ['charging', 'wireless', 'accessory'], stock: 88, rating: 4.3, reviewCount: 156, variants: [{ type: 'color', value: 'Space Gray', available: true }, { type: 'color', value: 'White', available: true }] },
];
